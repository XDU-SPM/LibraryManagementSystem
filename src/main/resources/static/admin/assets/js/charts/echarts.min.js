        ...
        var u = i(14), h = i(30), c = i(1), d = i(11), f = i(23), p = d.getDataItemValue, g = d.converDataValue, v = {
            cartesian2d: function (t, e, i) {
                ...
                var n = i.queryComponents({mainType: "polar", index: e.get("polarIndex"), id: e.get("polarId")})[0],
                    ...
                    u = r.get("type"), c = [{name: "radius", type: s(l), stackable: a(l)}, {
                        name: "angle",
                        type: s(u),
                        stackable: a(u)
	 ...
	 */
        ...
        u.prototype = {
            constructor: u, elCount: 0, __dirty: !0, initContext: function () {
                ...
                var t = this.dpr;
                this.domBack = r("switch_language-" + this.id, "canvas", this.painter, t), this.ctxBack = this.domBack.getContext("2d"), 1 != t && this.ctxBack.scale(t, t)
            }, resize: function (t, e) {
